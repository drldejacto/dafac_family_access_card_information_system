...
<div id="page-wrapper">
  <div class="container-fluid">
    <ol class="breadcrumb">
        <li class="active">
            <a href="{{ route('hc.index') }}"> <i class="glyphicon glyphicon-user"></i> Health Condition Libraries</a>
        </li>
    </ol>  
     <div class="row">
    ...
    <div class="row">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
                <form data-toggle="validator" method="POST" action="{{ route('hc.update', $hc->getOriginal('id')) }}"> 
                {{ csrf_field() }}
                {{ method_field('PATCH') }}  
                    <div class="row">
                      <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="input" class="form-control" name = "health_condition" value ="{{ $hc->health_condition }}" autofocus>
                            </div>
                      </div>
                    </div>
