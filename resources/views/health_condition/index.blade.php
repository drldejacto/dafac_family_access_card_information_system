...
<div id="page-wrapper">
    ...
    <div class="row">
               <div class="col-lg-12">
                    <a href="#outgo" data-toggle="modal" class="btn btn-default" data-target="#newHC">Add Library</a>
                </div>                   
    </div>
    <br>
    <div class="row">
        <div class="col-lg-12">
            <table width="100%" class="table table-striped table-bordered table-hover" id="healthCondition">
                <thead >
                    <tr>
                        <th>ID</th>
                ...
                <tbody class="tbody">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>@if($hc->status ==1) Active @else Inactive @endif</td> 
                        <td>{{ $hc->created_at }}</td>
                        <td width="100"><a href="{{ route('hc.edit',$hc->id)}}" class="btn btn-primary btnEdit">Edit</a></td> 
      ...
      <div class="modal fade" id="newHC">
          ...
          <div class="modal-body">
                  <form data-toggle="validator" class = "form-horizontal" method="POST" action="{{ route('hc.store')}}">
                   {{ csrf_field() }}
                      <div class="form-group">  
                            <label class="col-lg-4 control-label">Health Condition</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="health_condition" id="health_condition" required autofocus>
                            </div>
                      </div>
                      <div class="row">
